...
def _make_settings(**overrides):
    ...
    mock.kimi_proxy = ""
    mock.wafer_proxy = ""
    mock.telepub_voyage_api_key = "telepub_test_key"
    mock.telepub_voyage_base_url = "https://voyage.prod.telepub.cn/voyage/api"
    mock.telepub_voyage_proxy = ""
    mock.telepub_voyage_models = ""
...
def test_create_provider_instantiates_each_builtin():
    ...
    cases = {
        ...
        "wafer": WaferProvider,
        "telepub_voyage": TelepubVoyageProvider,
    }
